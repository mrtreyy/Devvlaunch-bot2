...
async function handleCallback(ctx) {
  ...
  if (data === 'join_group') {
    await ctx.answerCbQuery();
    await ctx.reply(`🌍 *Join DevLaunch Community*\n\nClick below to join our developer community!`, {
      parse_mode: 'Markdown',
      ...Markup.inlineKeyboard([Markup.button.url('🔗 Join Community', 'https://t.me/devvlaunchcommunity'), Markup.button.callback('⬅ Back', 'main_menu')])
    });
  }
